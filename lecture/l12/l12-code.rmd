...
```{r alternative-prob-above}
 ...
 pnorm( q=1.2, lower.tail = F)
 
## pnorm( q=1.2, lower.tail = T) the left tail
```
...
#### my version, calc the non shaded area, substract them from 1 :)
#### P(-0.8 < x < 1.5)
1 - ( pnorm( -0.8 ) + pnorm( 1.5, lower.tail=F ) )
...
>>>>>>> 41b64e9adc3bd984766f023ac518cab2ff0efcc9
