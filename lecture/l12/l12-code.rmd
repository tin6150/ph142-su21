...
heights.women <- rnorm(n = 10, mean = 64.5, sd = 2.5)
...
dens_sn0 = ggplot(heights.women, aes(x = heights.women)) + geom_density()  +
...
dens_zsn1 = ggplot(heights.women, aes(x = z)) + geom_density()  +
  #stat_function(fun = dnorm, col = "forest green")  +
  stat_function(fun = dchisq, col = "blue")  +
  theme_minimal(base_size = 15)
dens_zsn1
